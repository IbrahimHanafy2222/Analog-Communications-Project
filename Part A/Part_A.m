...
figure;
plot(t*1000, Demodulated_m1_1B, 'b', 'LineWidth', 1);
...
figure;
plot(t*1000, Demodulated_m2_2B, 'r', 'LineWidth', 1);
...
cutoff_Frequency=5000;
% Apply LPF
Demodulated_m1_1C = lowpass(Demodulated_m1_C,cutoff_Frequency,5*fs)/3; 
Demodulated_m2_2C = lowpass(Demodulated_m2_C,cutoff_Frequency,5*fs)/2;



figure;
subplot(2,1,1);
plot(t*1000, Demodulated_m1_1C, 'b', 'LineWidth', 1);
...
subplot(2,1,2); 
plot(t*1000, Demodulated_m2_2C, 'r', 'LineWidth', 1);
